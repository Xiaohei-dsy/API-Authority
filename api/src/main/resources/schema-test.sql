...
alter database authority_test default CHARACTER SET utf8 COLLATE utf8_general_ci;

create table IF NOT EXISTS authority_test.`user`
(
    ...
    create table IF NOT EXISTS authority_test.`system`
(
...
create table IF NOT EXISTS authority_test.`resource`
(
    `id` bigint(20) unsigned auto_increment comment '自增ID',
	...
	create table IF NOT EXISTS authority_test.`role`
(
    `id` bigint(20) unsigned auto_increment comment '自增ID',
    ...
    create table IF NOT EXISTS authority_test.`user_role`
(
    `id` bigint(20) unsigned auto_increment comment '主键ID',
    `username` varchar(50) not null comment '账号',
    `role_name` varchar(50) not null comment '角色名称',
...
create table IF NOT EXISTS authority_test.`logs`
(
    `id` bigint(20) unsigned auto_increment comment '主键ID',
    ...
    create table IF NOT EXISTS authority_test.`role_resource`
(
    `id` bigint(20) unsigned auto_increment comment '自增ID',
    `role_name` varchar(50) not null comment '角色名称',
    `system_id` varchar(50) not null comment '归属系统',
